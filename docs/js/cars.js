...
<svg viewBox="0 0 265 92" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <defs>
    ...
    <radialGradient id="carLight" cx="50%" cy="50%" r="50%">
      ...
      <stop offset="45%"  stop-color="#ff5a4a"/>
      <stop offset="100%" stop-color="rgba(255,45,58,0)"/>
    </radialGradient>
    <filter id="carGlow" x="-70%" y="-70%" width="240%" height="240%">
  ...
  <ellipse cx="20" cy="60" rx="14" ry="7" fill="url(#carLight)" filter="url(#carGlow)"/>
  <path d="M14 57 C18 55 23 55 27 57 L27 63 C22 65 18 65 14 63 Z" fill="#ffe9e6"/>
  <path d="M-14 60 L14 52 L14 68 Z" fill="url(#carLight)" opacity=".45" filter="url(#carGlow)"/>
